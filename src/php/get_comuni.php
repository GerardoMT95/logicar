...
//leggo i valori
	...
	try {
		...
		$statement = $conn->prepare("select codice,denominazione from comuni_italiani WHERE provincia=:prov OR metropolitana=:prov");
	...
	echo "<option value=" . $row['codice'] . ">". $row['denominazione'] . "</option>";
		   }
