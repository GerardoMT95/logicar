...
//leggo i valori
		   ...
		   from marca, auto, modello, parco, pren_prenotazioni p1,pren_auto,  pren_prenotazioni p2, viaggi_pianificati where
		   auto.id=parco.id_auto and marca.id=auto.id_marca and auto.id_modello=modello.id and parco.id_azienda=p1.azienda and p1.id='$pianificazione' 
		   AND parco.id=pren_auto.auto and viaggi_pianificati.stato='1' and `prenotazione`=idprenotazione and
