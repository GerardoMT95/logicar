...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": attiva per ordinare in senso ascendente",sSortDescending:": attiva per ordinare in senso decrescente"},oPaginate:{sFirst:"Primo",sLast:"Ultimo",sNext:"Prossimo",sPrevious:"Precedente"},sEmptyTable:"Nessun dato disponibile",sInfo:"Sto mostrando _START_ di _END_ su _TOTAL_ dati",sInfoEmpty:"Sto mostrando 0 to 0 of 0 dati",
sInfoFiltered:"(filtrati da _MAX_ dati totali)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostra _MENU_ dati",sLoadingRecords:"Sto caricando...",sProcessing:"Sto processando...",sSearch:"Ricerca:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nessun risultato corrispondente"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
